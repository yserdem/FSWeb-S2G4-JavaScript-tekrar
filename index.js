...
sayilar.forEach((element) => {
	myNumbers[element] = (myNumbers[element] || 0) + 1
});

Object.values(myNumbers).forEach((element,index) => {
	if (element > 1) {
		tekraredensayilar.push(Object.keys(myNumbers)[index] + " sayısı " + element + " kere tekrar edilmiştir")
	}
});
